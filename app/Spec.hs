...
result1 = T.intercalate "\n"
    ...
    , ""
    , ""
    , "\\begin{tabular}{|l|l||c||}\\hline \\multicolumn{2}{|l||}{}&$\\cHc$\\\\\\cline{1-3}\\hline \\hline \\multicolumn{2}{|l||}{$\\INIT \\lor \\mSt = \\invalid \\lor \\neg \\validRange \\lor \\mSw = \\sOff $}&$\\sOff$\\\\\\cline{1-3}\\multicolumn{1}{|l|}{\\multirow{3}{*}{$\\begin{array}{rl}&\\neg \\INIT\\\\\\land&\\mSt = \\valid\\\\\\land&\\validRange \\\\\\land& \\mSw = \\sOn \\end{array}$}}&\\multicolumn{1}{|l||}{$\\mTm < \\mDl$}&$\\sOn$\\\\\\cline{2-3}\\multicolumn{1}{|l|}{}&\\multicolumn{1}{|l||}{$\\between{\\mDl}{\\mTm}{\\mDh}$}&$\\preCHc$\\\\\\cline{2-3}\\multicolumn{1}{|l|}{}&\\multicolumn{1}{|l||}{$\\mDh < \\mTm$}&$\\sOff$\\\\\\cline{1-3}\\end{tabular}"
    , ""
    , ""
    , ""
    , ""
    , ""
    , ""
    , "\\begin{tabular}{|l|l|l||c||}\\hline \\multicolumn{3}{|l||}{}&$\\cAl$\\\\\\cline{1-4}\\hline \\hline \\multicolumn{3}{|l||}{$\\cMd \\in \\{ \\off, \\init \\} $}&$\\sOff$\\\\\\cline{1-4}\\multicolumn{1}{|l|}{\\multirow{3}{*}{$\\cMd \\in \\{ \\normal, \\fail \\} $}}&\\multicolumn{2}{|l||}{$\\problem$}&$\\sOn$\\\\\\cline{2-4}\\multicolumn{1}{|l|}{}&\\multicolumn{1}{|l|}{\\multirow{2}{*}{$\\neg \\problem$}}&\\multicolumn{1}{|l||}{$\\neg \\heldfor \\lor \\hysteresis$}&$\\preCAl$\\\\\\cline{3-4}\\multicolumn{1}{|l|}{}&\\multicolumn{1}{|l|}{}&\\multicolumn{1}{|l||}{$\\heldfor \\land \\neg \\hysteresis$}&$\\sOff$\\\\\\cline{1-4}\\end{tabular}"
    , ""
    , ""
    , "\\end{document}"
    ]
